...
error_reporting(E_NOTICE);
	...
	if(isset($_GET['id'])) {
		$_SESSION['s_id'][$id] = $data['id'];
		$_SESSION['s_name'][$id] = $data['name'];
		$_SESSION['s_price'][$id] = $data['price'];
			...
			<div class="container">
				...
				<div class="col-md-8 order-details">
					...
					if(empty($_SESSION['s_id'])) {
						?>
						<a href="store1.php" class="btn btn-success" onClick="alert('กรุณาเลือกสินค้า');">สั่งซื้อสินค้า</a> 
						<?php } else { ?>
						...
						<div class="section-title text-center">
							<h3 class="title">รายการสินค้าของคุณ</h3>

							<?php
							if(!empty($_SESSION['s_id'])) {
								foreach($_SESSION['s_id'] as $pid) {
									@$i++;
									$sum[$pid] = $_SESSION['s_price'][$pid] * $_SESSION['s_item'][$pid] ;
									@$total += $sum[$pid] ;
?>
						...
						<div class="order-summary">
							...
							<div class="order-products">
								<div class="order-col">
									<div><p><?=$_SESSION['s_name'][$pid];?></p></div>
									<!-- <div>qty</div> -->
									<div><p><?=$_SESSION['s_price'][$pid];?></p></div>
								</div>
								<!-- <div class="order-col">
									<div>ชื่อสินค้า</div>
									<div>qty</div>
							...
							<div class="order-col">
								<div><strong>การจัดส่ง</strong></div>
...
?>
	<tr>
		<div class="section-title text-center">
			<h3 class="sub-title">ไม่มีสินค้าในรายการตะกร้าของคุณ</h3>
		</div>
	</tr>
<?php } // end if ?>
						...
						<a href="#" class="primary-btn order-submit">ชำระเงินตอนนี้ !</a>
					</div>
